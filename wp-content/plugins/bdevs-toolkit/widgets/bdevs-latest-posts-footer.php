...
Class Latest_posts_footer_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-latest-posts-footer', 'BildPress Footer Posts Image', array(
				...
				?>
		            <div class="widget-post-list fix">
		                ...
		                <div class="widget-posts-body">
		                	<div class="widget-posts-meta"><i class="fal fa-calendar-alt"></i> <?php the_time('F d, Y'); ?> </div>
