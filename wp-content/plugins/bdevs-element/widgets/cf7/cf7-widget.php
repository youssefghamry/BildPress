...
class CF7 extends BDevs_El_Widget {
	...
	protected function register_content_controls() {
        ...
        $repeater->add_control(
            'tab_url',
            [
                'label' => __( 'Tab URL', 'bdevselement' ),
                'description' => bdevs_element_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'tel:926668880000', 'bdevselement' ),
                'placeholder' => __( 'Set tab URL', 'bdevselement' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'title_1', 'class', 'section-title white-color' );
        ...
        <?php elseif ( $settings['design_style'] === 'style_2' ): 
            ...
            $this->add_render_attribute( 'title', 'class', 'text-whites' );
                ...
                <div class="row">
                    <div class="col-xxl-5 col-xl-6 col-lg-6">
                        <div class="title_style1 p-0">
                            ...
                            <h5 class="text-whites"><?php echo bdevs_element_kses_intermediate( $settings['sub_title'] ); ?></h5>
                            <?php endif; ?>
                        ...
                        <div class="contact-info mr-50 mr-xs-0  mr-md-0">
                            ...
                            <div class="single-contact-info d-flex align-items-center">
                                <div class="contact-info-icon">
                                    <a href="<?php echo esc_url( $slide['tab_url'] ); ?>">
                                ...
                                <div class="contact-info-text mt-10">
                                    ...
                                    <?php if (!empty($slide['tab_content'])) : ?>
                                        <h5><a href="<?php echo esc_url( $slide['tab_url'] ); ?>"><?php echo bdevs_element_kses_basic($slide['tab_content']); ?></a></h5>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <?php endforeach; ?>
