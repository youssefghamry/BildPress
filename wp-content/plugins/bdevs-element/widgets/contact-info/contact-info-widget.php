	...
	protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => 'Back',
                'placeholder' => __( 'Back Text', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
                            ...
                            <div class="contact_list__wrapper">
                                ...
                                <div class="contact1__item border-bottom-widget pb-35 mt-40">
                                    ...
                                    <div class="contact1__content">
                                        <h4><?php echo bdevs_element_kses_basic( $slide['tab_title'] ); ?></h4>
                                        <p>
                                            <?php echo bdevs_element_kses_intermediate( $slide['tab_content'] ); ?>
                                        </p>
                                    </div>
                                </div>
                                <?php endforeach; ?>
