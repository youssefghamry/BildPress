...
class Project_Box extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'Project Box', 'bdevselement' );
    }
	...
	protected function render() {
        ...
        <div class="about-us-area about-us2-area pt-165 pb-90 about-circle">
            <div class="container">
                <div class="row">
    ...
    public function _content_template() {
        ...
        if ( bdevs_element_has_icon_library() ) {
            iconHTML = elementor.helpers.renderIcon( view, settings.selected_icon, { 'aria-hidden': true }, 'i' , 'object' ),
            migrated = elementor.helpers.isIconMigrated( settings, 'selected_icon' );
            btnIconHTML = elementor.helpers.renderIcon( view, settings.button_selected_icon, { 'aria-hidden': true, 'class': 'btn-icon' }, 'i' , 'object' ),
            btnMigrated = elementor.helpers.isIconMigrated( settings, 'button_selected_icon' );
        }

        view.addInlineEditingAttributes( 'title', 'basic' );
        view.addRenderAttribute( 'title', 'class', 'bdevs-infobox-title' );

        view.addInlineEditingAttributes( 'description', 'intermediate' );
        view.addRenderAttribute( 'description', 'class', 'bdevs-infobox-text' );

        view.addInlineEditingAttributes( 'button_text', 'none' );
        view.addRenderAttribute( 'button_text', 'class', 'btn-text' );

        view.addRenderAttribute( 'button', 'class', 'btn btn--link' );
        ...
        <div class="about-us-area about-us2-area pt-165 pb-90 about-circle">
            ...
            <# if ( settings.button_selected_icon || settings.button_icon ) {
                if ( bdevs_element_has_icon_library() && btnIconHTML && btnIconHTML.rendered && ( ! settings.button_icon || btnMigrated ) ) {
                    btnIcon = btnIconHTML.value;
                } else if ( settings.button_icon ) {
                    btnIcon = '<i class="btn-icon ' + settings.button_icon + '" aria-hidden="true"></i>';
                }
            } #>
            ...
            <figure class="bdevs-infobox-figure bdevs-infobox-figure--icon">
                <# if ( bdevs_element_has_icon_library() && iconHTML && iconHTML.rendered && ( ! settings.icon || migrated ) ) { #>
                    {{{ iconHTML.value }}}
                <# } else { #>
