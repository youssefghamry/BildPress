...
class Time extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->start_controls_section(
            '_section_slides',
            [
                'label' => __( 'Time schedule', 'bdevselement' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'label' => __( 'Icon Name', 'bdevselement' ),
                'default' => __( 'fal fa-arrow-down', 'bdevselement' ),
                ...
                <div class="row mt-none-30">
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6 mt-30">
                        <div class="single-time-schedule">
                            <div class="icon">
                                <i class="<?php echo bdevs_element_kses_basic( $slide['icon'] ); ?>"></i>
                            </div>
                            <div class="content">
                                <h4 class="title"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h4>
                                <span><?php echo bdevs_element_kses_basic( $slide['description'] ); ?></span>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6 text-right mt-30">
                        ...
                        <?php elseif ( $settings['button_text'] && ( ! ( empty( $settings['button_selected_icon'] ) || empty( $settings['button_selected_icon']['value'] ) ) || ! empty( $settings['button_icon'] ) ) ) :
                            if ( $settings['button_icon_position'] === 'before' ) :
                                $this->add_render_attribute( 'button', 'class', 'site-btn white bdevs-btn--icon-before' );
