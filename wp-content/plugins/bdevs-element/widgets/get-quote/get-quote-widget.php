...
class Get_Quote extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'Get Quote', 'bdevselement' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'bdevs sub title here', 'bdevselement' ),
        ...
        $this->add_control(
            'link',
            [
                'label' => __( 'Box Link', 'bdevselement' ),
                'separator' => 'before',
    ...
    protected function register_style_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Title & Sub Title', 'bdevselement' ),
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-10">
                        <div class="section-heading">
                            ...
                            <h4 <?php $this->print_render_attribute_string( 'sub_title' ); ?>><?php echo bdevs_element_kses_intermediate( $settings['sub_title'] ); ?></h4>
                            <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-xl-7 col-lg-10">
                                    <div class="section-heading">
                                        ...
                                        <h2 class="section-title">Make An Appointment <br> Right Now</h2>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 my-auto text-right">
