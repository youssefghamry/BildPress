...
class Carousel extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'Carousel', 'bdevselement' );
    }
	...
	protected function register_content_controls() {
        ...
        $this->add_control(
            'center',
            [
                'label' => __( 'Center Mode?', 'bdevselement' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'bdevselement' ),
                'label_off' => __( 'No', 'bdevselement' ),
                'return_value' => 'yes',
                'description' => __( 'Best works with odd number of slides (Slides To Show) and loop (Infinite Loop)', 'bdevselement' ),
                'frontend_available' => true,
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_responsive_control(
            'slides_to_show',
            [
                'label' => __( 'Slides To Show', 'bdevselement' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => __( '1 Slide', 'bdevselement' ),
                    2 => __( '2 Slides', 'bdevselement' ),
                    3 => __( '3 Slides', 'bdevselement' ),
                    4 => __( '4 Slides', 'bdevselement' ),
                    5 => __( '5 Slides', 'bdevselement' ),
                    6 => __( '6 Slides', 'bdevselement' ),
                ],
                'desktop_default' => 4,
                'tablet_default' => 3,
                'mobile_default' => 2,
    ...
    protected function register_style_controls() {
        $this->start_controls_section(
            '_section_style_item',
            [
                'label' => __( 'Carousel Item', 'bdevselement' ),
        ...
        $this->add_responsive_control(
            'item_spacing',
            [
                'label' => __( 'Slide Spacing (px)', 'bdevselement' ),
