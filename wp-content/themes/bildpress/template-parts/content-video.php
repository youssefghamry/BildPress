...
$bildpress_video_url = function_exists('get_field') ? get_field( 'fromate_style' ) : NULL;
...
if( is_single() ): ?>
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox postbox-2 singel-post format-image mb-50'); ?> >
        ...
        <div class="postbox_thumb">
            ...
            <a href="<?php print esc_url($bildpress_video_url); ?>" class="video-link popup-video">
...
<?php
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox postbox-2 format-video mb-50'); ?>>
        <?php if( has_post_thumbnail() ): ?>
        <div class="postbox_thumb">
            <a href="<?php the_permalink(); ?>">
                <?php the_post_thumbnail('full', array('class' => 'img-responsive' )); ?>
